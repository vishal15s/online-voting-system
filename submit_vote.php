...
session_start();
if(empty($_POST['lan'])){
$error="<h4><font color='#ffffff'>Please select a candidate !</h4></font>";
include"voter.php";
exit();
}
$lan = $_POST['lan'];
...
if(mysqli_num_rows($sql) > 0 ) {
	$msg="<h4><font color='#ffffff'>You have already been voted, No need to vote again</h4></font>";
		include 'voter.php';
		exit();	
}
else{
...
$sql3 = mysqli_query($con, 'UPDATE voters SET voted= "'.$_POST['lan'].'" WHERE username="'.$_SESSION['SESS_NAME'].'"');
	...
	$msg="<h4><font color='#ffffff'>Congratulation, you have made your vote.</h4></font>";
	include 'voter.php';
	exit();
	}
}
