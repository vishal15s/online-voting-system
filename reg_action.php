...
$exist = mysqli_num_rows($sq);
		...
		if($exist==1){
		$nam="<center><h4><font color='#ffffff'>The username already exist, choose another.</h4></center></font>";
		unset($username);
		include('register.php');
		exit();
		}
...
if (!$sql2) { 
	...
	echo '<script>alert("Registered Successfully.Login to vote ")</script>';
	include('login.php');	

}
}
else {
	 $error="<center><h4><font color='#ffffff'>Registration Failed Due To Error !</h4></center></font>";
     include"register.php";
}
?>
